...
<html lang="en-US">
	<head>
	<title>Quick Response (QR) Code Generator Using PHP QR CODE Library</title>
	...
	<body onload="startTime()">
		...
		<div class="myoutput">
			<h3><strong>Quick Response (QR) Code Generator Using PHP QR CODE Library</strong></h3>
			...
			<div class = "dllink" style="text-align:center;margin:-100px 0px 50px 0px;">
				<a href="https://www.sourcecodester.com/htmlcss/11285/text-reveal-mouse-hover.html" class="btn btn-danger" target="_blank">Download Source Code</a>
			</div>
		</div>
	</body>
</html>